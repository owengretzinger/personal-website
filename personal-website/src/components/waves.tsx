...
export function Wave1() {
    return (
        <div className="absolute origin-top-left left-0 right-0 top-0 -z-10">
            <svg viewBox="0 0 818 818" xmlns="http://www.w3.org/2000/svg" className={`fill-blue w-[818px] h-[818px] max-w-full max-h-[100vw] ${animations.changeFillOnStartToWave}`}>
...
export function Wave4() {
    return (
        <div className="absolute origin-bottom-right left-0 right-0 bottom-0 -z-10 flex justify-end">
            <svg viewBox="0 0 565 1098" xmlns="http://www.`3.org/2000/svg" className={`fill-blue w-[565px] h-full ${animations.changeFillOnStartToWave}`}>
